...
class Grid:
    ...
    def compute_geometry(self): #crea la mesh -> definisce il passo h e i nodi con linspace
        """
    ...
    def plot(self): #rappresentazione della mesh
        """
...
#valutazione della funzione nei nodi della griglia
def fun2dof(grid, f):
    """
...
def simpcomp(f, a, b, N): #usiamo la quadratura numerica di Simpson composito per il calcolo dell'errore L2
    """
